...
//  HelpMeWatch
//
//  Created by Akshay Bharath on 3/19/16.
...
class CoreDataStack {
  ...
  init() {
    ...
    let modelURL = bundle.URLForResource("HelpMeWatch", withExtension: "momd")
    ...
    let storeURL = documentsURL.URLByAppendingPathComponent("HelpMeWatch.sqlite")
